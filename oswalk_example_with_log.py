...
This version writes the result to a log file (findfiletype.log). 
The log file is opened in append mode; it will not overwrite a log file that 
exists already, it will only append to the file. 
